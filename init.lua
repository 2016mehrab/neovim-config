    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- NOTE: ESHAN ADDED THIS TO AUTO FORMAT ON SAVE
...
-- NOTE: ESHAN IS SETTING DEFAULT THEME
...
vim.keymap.set('n', '<leader>rec', 'qm',
  { noremap = true, silent = true, desc = "Start recording macro into register 'm'" })
